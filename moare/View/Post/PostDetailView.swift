            ...
            VStack {
                    Rectangle()
                        ...
                        HStack {
                            ...
                            HStack {
                                if post.like!.contains(postVM.username) {
                                    Image(systemName: "heart.fill")
                                        .font(.system(size: 23))
                                        .padding(.trailing, 10)
                                        .foregroundColor(Color("moare"))
                                        .onTapGesture {
                                            postVM.unlike(post: post, listIndex: listIndex, postIndex: postIndex)
                                        }
                                } else {
                                    Image(systemName: "heart")
                                        ...
                                        .padding(.trailing, 10)
                                        .onTapGesture {
                                            postVM.like(post: post, listIndex: listIndex, postIndex: postIndex)
                                        }
                                }
            ...
            if alertState == .report {
                ...
                return Alert(
                    ...
                    dismissButton: .cancel(Text(StringResources.confirm)) {
                        postVM.removeReportedPost(listIndex: listIndex, postIndex: postIndex)
                    }
                )
            }
        }
